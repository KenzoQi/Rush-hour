...
import { StyleSheet, View, TextInput, TouchableOpacity, Dimensions, Image, FlatList, Text } from 'react-native';
...
export default function Homepage() {
  ...
  const selectSuggestion = (suggestion) => {
    ...
    setFilteredSuggestions([]);
    handleLocationSearch(suggestion); // Update map with the selected location
  };
        ...
        <View style={styles.searchContainer}>
          ...
          <View style={styles.inputWrapper}>
            <TextInput
              ...
              placeholder={currentLocationText ? '' : "Location"} // Clear placeholder when text is entered
              value={currentLocationText}
              onChangeText={handleLocationInputChange}  // Use updated handler
            />
            {currentLocationText !== '' && (
          ...
          <View style={styles.inputWrapper}>
            <TextInput
              style={styles.searchInput}
              placeholder={destinationText ? '' : "Where to?"} // Clear placeholder on selection
              value={destinationText}
              onChangeText={handleLocationSearch}
            />
            <TouchableOpacity onPress={() => handleLocationSearch(destinationText)} style={styles.searchButton}>
